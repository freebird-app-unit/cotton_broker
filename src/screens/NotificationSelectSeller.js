...
class NotificationSelectSeller extends Component {
  ...
  getStationName = (districtID) => {
    ...
    getSellerList = (countryId,stateID,districtID,stationID) => {

      console.log("seller params---"+countryId+'--'+stateID+'--'+districtID+'--'+stationID)

    let data = {user_type:"seller",country_id:"1",state_id:stateID,city_id:districtID,station_id:stationID}
    var self = this;
    const formData = new FormData();
    formData.append('data', JSON.stringify(data));
...
//  {"seller_buyer_id":"1","product_id":"1","price":"50000","no_of_bales":"50","d_e":"export","buy_for":"other","spinning_meal_name":"test","country_id":"1","state_id":"1","city_id":"1","station_id":"1","buyers":[{"id":"1","type":"default"}],"attribute_array":[{"attribute":"uhml","attribute_value":"28.3"},{"attribute":"rd","attribute_value":"21.3"}]}
    let data ={"seller_buyer_id":sbid,"product_id":productId,
...
onClickRowSeller=(item)=>{
   ...
   _renderItem ({ item, index }) {
    ...
    return (     <TouchableOpacity style={{backgroundColor:'white'}} onPress={() => this.onClickRowSeller(item)}> 
                  ...
                  {item.isSelected && <Checked  style={{ width: 30,
                          height: 30,
                          marginRight:10}} />}

                   {!item.isSelected && <Unchecked  style={{ width: 30,
                          height: 30,
                          marginRight:10}} />}
                  ...
                  <View style={{flex:1}}>
                     <Text numberOfLines={1} 
                          ...
                          style={{flex: 1,
                            ...
                            textAlignVertical:'center'}}>{item.label}</Text>
              ...
              <View style={{marginLeft:'5%',marginRight:'5%'}}>
                    ...
                    <Text numberOfLines={1} 
                          ...
                          style={{flex: 1,
                            ...
                            textAlignVertical:'center'}}>State</Text>
              ...
              <View style={{marginLeft:'5%',marginTop:10,marginRight:'5%'}}>
                ...
                <Text numberOfLines={1} 
                          ...
                          style={{flex: 1,
                            ...
                            fontSize:16,
                            fontFamily:'Poppins-SemiBold',
                            textAlignVertical:'center'}}>District</Text>
...
<SelectDropdown
              ...
              onSelect={(selectedItem, i) => {
                //this.changeState(selectedItem.value)
                this.changeDistrict(selectedItem.value)
              }}
            ...
            />
             ...
             <View style={{marginLeft:'5%',marginTop:10,marginRight:'5%'}}>
                ...
                <Text numberOfLines={1} 
                 ...
                 {/* <DropDownPicker
                            placeholder={this.state.stationDrpDwnPlaceholder}
                            open={this.state.stationOpenState}
                            value={this.state.stationValue}
                            items={this.state.stationlist}
                            setOpen={this.setStationOpenState}
                            setValue={this.setStationValue}
                            setItems={this.setStationItemsState}
                            containerStyle={{height: 50,width:'100%',marginTop:10}}
                            listMode="MODAL"
                            scrollViewProps={{
                              decelerationRate: "fast"
                            }} 
                          onChangeValue={item => this.changeStation(item)}  
                            /> */}
