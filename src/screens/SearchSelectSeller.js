...
class SearchSelectSeller extends Component {
  ...
  onClickView=(data)=>{
      console.log('View data is...'+JSON.stringify(data))
      let passData = {type:"post",cameFrom:'Search',bales_required:this.props.route.params.bales,post_id:data.post_id,buyerId:data.seller_buyer_id,current_price:data.price,current_no_of_bales:data.bales,payment_condition:'',transmit_condition:'',lab:''}
      this.props.navigation.navigate('DealDetails',{data:passData,type:"post"});
  }
  ...
  return viewData.map((ell, i) => (
            <View><TouchableOpacity  onPress={() => this.onClickCountry(ell)}>
           ...
           <View style={{flex:1,marginLeft:'5%',marginTop:10,marginRight:'5%',height:40}}>
                     <Text numberOfLines={1} 
                          ...
                          style={{flex: 1,
                            ...
                            textAlignVertical:'center'}}>Buyer</Text>
                    ...
                    <Text numberOfLines={1} 
                          ...
                          style={{flex: 1,
                            ...
                            fontSize:12,
                            fontFamily:'Poppins-Regular',
                            textAlignVertical:'center'}}>{ell.name}</Text>
                   ...
                   <View style={{flex:1,marginLeft:'5%',marginTop:10,marginRight:'5%',height:40}}>
                     <Text numberOfLines={1} 
                          ...
                          style={{flex: 1,
                            ...
                            opacity:.5,
                            fontFamily:'Poppins-Regular',
                            textAlignVertical:'center'}}>Price</Text>
                    ...
                    <Text numberOfLines={1} 
                          ...
                          style={{flex: 1,
                            ...
                            fontSize:12,
                            fontFamily:'Poppins-Regular',
                            textAlignVertical:'center'}}>₹ {ell.price}({ell.no_of_bales})</Text>

                  </View>


              <View style={{flex:1,width:'100%',marginLeft:'1%',marginTop:10,marginRight:'5%',height:35}}>
                  <TouchableOpacity onPress={() => this.onClickView(ell)}>
                      ...
                      <Text numberOfLines={1} 
                          ...
                          style={{width:'100%',
                            ...
                            fontFamily:'Poppins-Regular',
                            textAlignVertical: 'center'}}>View</Text>
  ...
  return stationData.map((ell, i) => (
            <View><TouchableOpacity  onPress={() => this.onClickCountry(ell.state)}><View style={{flexDirection: 'row',marginLeft:'5%',marginTop:0,marginRight:'5%',height:40,alignItems:'center'}}>
                  <View style={{flex:1}}>
                     <Text numberOfLines={1} 
                          ellipsizeMode='tail' 
                          style={{flex: 1,
                            ...
                            textAlign:'left',
                            fontFamily:'Poppins-Regular',
                            textAlignVertical:'center'}}>{ell.name} ({ell.count})</Text>
                  </View>
                  <DownArrow style={{ width: 30,
                          height: 30,
                          marginRight:10}}></DownArrow>
...
crateProductAttributeUI2=(stateData)=>{
  ...
  return this.props.route.params.data.data.map((ell, i) => (
   ...
   _renderItemCountry ({ item, index }) {
    ...
    return (<TouchableOpacity  onPress={() => this.onClickCountry(item.state)}><View style={{flexDirection: 'row',marginLeft:'5%',marginTop:0,marginRight:'5%',height:40,alignItems:'center'}}>
                  ...
                  <View style={{flex:1}}>
                     <Text numberOfLines={1} 
                          ...
                          style={{flex: 1,
                            ...
                            textAlign:'left',
                            fontFamily:'Poppins-Regular',
                            textAlignVertical:'center'}}>{item.name} ({item.count})</Text>
  ...
  _keyExtractorState (item, index) {
   ...
   _renderItemState ({ item, index }) {
    return (       <View style={{flexDirection: 'row',marginLeft:'5%',marginTop:0,marginRight:'5%',height:40,alignItems:'center',}}>
              ...
              <View style={{flexDirection: 'row',marginLeft:'5%',marginRight:'5%',height:40}}>
                    ...
                    <Text numberOfLines={1} 
                          ...
                          style={{flex: 1,
                            ...
                            fontSize:16,
                            fontFamily:'Poppins-SemiBold',
                            textAlignVertical:'center'}}>{this.props.route.params.pn}</Text>
                    ...
                    <Text numberOfLines={1} 
                          ...
                          style={{width:'50%',
                            ...
                            alignItems: 'center',
                            color:theme.colors.blackBG,
                            textAlignVertical: 'center'}}>{this.props.route.params.info.no_of_bales} Bales</Text>
              </View>
