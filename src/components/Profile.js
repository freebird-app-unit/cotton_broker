        ...
        try {
            ...
            axios({
                ...
                headers: {
                    ...
                    'Authorization': 'Bearer ' + d.api_token
                },
 ...
 return props.value ? <View style={{ marginTop: hp(2), alignSelf: 'flex-start' }}>
    ...
    return (
        <ScrollView style={backgroundStyle}>
            ...
            {Props.length <= 0 ? (<Spinner visible={spinner} color="#085cab" />) : (<View style={{ flex: 1, backgroundColor: 'white', alignItems: 'center', flexDirection: 'column', paddingHorizontal: wp(5) }}>
    ...
    fontFamily: "Poppins-Bold",
                ...
                <LabelValue label='Contact Person Name' value={Props.name || 'not provided'} />
